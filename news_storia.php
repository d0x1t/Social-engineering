...
<html>
    <head>
	<title>CONTENUTI | Social Engineering</title>
    <meta charset="UTF-8">
...
<div id="contenutoNews" class="news-container"> 
    <div class="argomento"> 
        <div class="testo">
            ...
            <p class="descrizione">Dietro la storia di Meloni, vittima di uno scherzo del duo comico russo, 
                                    si cela molta della classica sapienza da social engineering che i...
            </p>
        </div>
    ...
    <div class="argomento"> 
        <div class="testo">
            ...
            <p class="descrizione">Dietro il raggiro online emerge oggi una nuova forma: il social engineering.
                                Questo tipo di attacco informatico non si basa su algoritmi complessi o...
            </p>
        </div>
        <img src="foto_news/cellulare.jpeg" alt="News Image" class="image">
    </div>
</div> ';
}elseif(isset($_GET['storia'])){
    echo '<div id="mainStoria">';
    include("header.php");
echo '
